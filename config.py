...
CARTOON_LABELS = path.join(ROOT_PATH, 'cartoon_set/labels.csv')

CARTOON_IMG_TEST = path.join(ROOT_PATH, 'cartoon_set_test/img')
CARTOON_TEST_LABELS = path.join(ROOT_PATH, 'cartoon_set_test/labels.csv')
